...
import { Language, Problem, ProblemType, TestCase } from 'src/app/challenge/model/problem.model';
import { ProblemService } from 'src/app/challenge/service/problem.service';
...
export class CreateProblemComponent implements OnInit {
  ...
  previewProblemStatement(problemStatement : string){    
    const initialState = {
      code : problemStatement
    };
    this.modalService.show(HtmlPreviewComponent, {initialState, class : 'modal-lg'});      
  }
